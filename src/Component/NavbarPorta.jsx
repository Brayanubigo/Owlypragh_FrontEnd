...
export default function NavbarPorta() {
  ...
  <div className=' container py-10 px-10 mx-0 min-w-full flex flex-col items-center absolute '>
      <h1 className=' relative  text-5xl font-mono lg:py-[15rem]  max-[640px]:hidden sm:py-[9rem] text-black font-semibold '>Mi Portafolio</h1>
